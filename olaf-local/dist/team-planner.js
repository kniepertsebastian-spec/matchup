...
export async function mountTeamPlanner({collection,matchups,matchup}){
 ...
 function render(){
  ...
  element.querySelector('.team-shell').addEventListener('toggle',e=>{if(e.target.isConnected){state.open=e.target.open;save();}});
