...
export function parseRoute(hash){
 ...
 const adc=parts[0]==='adc';if(adc)parts.shift();
 return {champion,...(adc?{role:'adc'}:{}),page:parts[0]==='leitfaden'?'guide':parts[0]==='matchup'?'matchup':'list',slug:parts[0]==='matchup'?parts[1]:undefined};
}
